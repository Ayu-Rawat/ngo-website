...
export default function LoginContent() {
  return (
    <div style={{ display:"flex", minHeight:"100vh", alignItems:"center", justifyContent:"center", background: "#f5f5f5" }}>
      <div style={{ background:"#fff", padding:"2rem", borderRadius:12, border:"1px solid #e0e0e0", maxWidth:400, width:"calc(100% - 32px)", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
        <h1 style={{ marginTop:0, color: "#333" }}>Sign In</h1>
        <p style={{ opacity:.7, color: "#666" }}>Sign in to access your account and manage your profile</p>
        <a
          href="/login/google"
          style={{
            display:"inline-flex", gap:8, alignItems:"center",
            background:"#fff", color:"#333", padding:"12px 20px",
            borderRadius:8, textDecoration:"none", border:"1px solid #ddd", marginTop:"1rem",
            fontWeight: 500,
            transition: "all 0.2s"
          }}
          onMouseOver={(e) => {
